// Local Qur'an surah metadata (114 surahs) — generated once from api.alquran.cloud.
// Kept local so fuzzy search is fully offline and the app depends on no
// unverified third-party text feeds at runtime (see CONTENT-POLICY).
